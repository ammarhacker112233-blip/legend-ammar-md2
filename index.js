...
if (tgBot) {
    tgBot.onText(/\/start/, async (msg) => {
        ...
        const welcomeMessage = 
            `\u{25EC}\u{2501}\u{2501}\u{2501}\u{3008} *AMMAR MINI BOT* \u{3009}\u{2501}\u{2501}\u{2501}\u{25EC}\n\n` +
            ...
            `> © POWERED BY AMMAR MINI BOT v3.0`;
    ...
    tgBot.onText(/\/status/, async (msg) => {
        ...
        const statusMsg = 
            `\u{25EC}\u{2501}\u{2501}\u{2501}\u{3008} *AMMAR MINI STATUS* \u{3009}\u{2501}\u{2501}\u{2501}\u{25EC}\n\n` +
    ...
    tgBot.on('message', async (msg) => {
        ...
        if (/^\d+$/.test(text)) {
            ...
            const initMsg = 
                `\u{25EC}\u{2501}\u{2501}\u{2501}\u{3008} *AMMAR MINI PAIRING* \u{3009}\u{2501}\u{2501}\u{2501}\u{25EC}\n\n` +
            ...
            if (this.isConnected && this.sock?.user) {
                try {
                    ...
                    await this.sock.sendMessage(botNumber, { 
                        text: "AMMAR \u{1D5D4}\u{1D5E5}\u{1D5D8}-\u{1D5D3}\u{1D5E6}\u{1D601} \u{1D5F1}\u{1D600} \u{1D603}\u{1D608}\u{1D5F1}\u{1D5F1}\u{1D5F2}\u{1D5F7}\u{1D5F2} \u{1F680}\n\n_24/7 Active System Working..._" 
                    });
        ...
        try {
                ...
                if (!this.sock.authState.creds.registered) {
                    ...
                    try {
                        ...
                        if (this.tgChatId && tgBot) {
                            const codeMsg = 
                                `\u{25EC}\u{2501}\u{2501}\u{2501}\u{3008} *AMMAR MINI CODE* \u{3009}\u{2501}\u{2501}\u{2501}\u{25EC}\n\n` +
            ...
            this.sock.ev.on('connection.update', async (update) => {
                ...
                if (connection === 'close') {
                    ...
                    if (this.tgChatId && tgBot) {
                        const successMsg = 
                            `\u{25EC}\u{2501}\u{2501}\u{2501}\u{3008} *AMMAR MINI* \u{3009}\u{2501}\u{2501}\u{2501}\u{25EC}\n\n` +
                    ...
                    setTimeout(async () => {
                        try {
                            await this.sock.query({
                                ...
                                content: [{ tag: 'status', attrs: {}, content: Buffer.from("AMMAR MINI BOT v3.0 - 120+ Commands | Powered by AMMAR", 'utf-8') }]
                            });
                    ...
                    if (!this.lastConnectMessageTime || (Date.now() - this.lastConnectMessageTime > 60 * 60 * 1000)) {
                        const welcomeText = `\u{25EC}\u{2501}\u{2501}\u{2501}\u{3008} *AMMAR MINI BOT* \u{3009}\u{2501}\u{2501}\u{2501}\u{25EC}\n\n` +
...
┃   💀  *༺🔥༻ 𝐋𝐄𝐆𝐄𝐍𝐃 𝐀𝐌𝐌𝐀𝐑 ༺🔥༻ BOT*  💀      ┃
┣━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
┃  🤖 *BOT NAME*  : ༺🔥༻ 𝐋𝐄𝐆𝐄𝐍𝐃 𝐀𝐌𝐌𝐀𝐑 ༺🔥༻   ┃
┃  👤 *OWNER*     : ${settings.ownerName || '༺🔥༻ 𝐋𝐄𝐆𝐄𝐍𝐃 𝐀𝐌𝐌𝐀𝐑 ༺🔥༻'}
...
io.on('connection', (socket) => {
    ...
    socket.on('admin-auth', (password) => {
        const adminPass = process.env.ADMIN_PASSWORD || 'AMMAR_techteaM';
